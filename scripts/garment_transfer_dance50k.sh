export OUTPUT_DIR=/data/Projects-warehouse/DiOR/outputs/dior_dance50k_noshuffle
export NAME=dior_dance50k_fg_3epoch
...
--n_cpus 4 --gpu_ids 1 --batch_size 8 --square --crop_size 512
